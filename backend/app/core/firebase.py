...
class FirebaseClient:
    ...
    def _initialize_firebase(self):
        ...
        1. GOOGLE_APPLICATION_CREDENTIALS env var pointing to JSON file (AWS/production recommended)
        2. FIREBASE_CREDENTIALS_JSON env var with inline JSON string (alternative)
        """
        import os
        import json
